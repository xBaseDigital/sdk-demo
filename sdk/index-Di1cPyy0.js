import { T as Pe, M as nt, R as k, a as re, E as ho, C as O, b as z, O as K, c as fe } from "./index-0OLq1Bp7.js";
import { r as fo, m as mo } from "./index-BICYWWxO.js";
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const rt = window, An = rt.ShadowRoot && (rt.ShadyCSS === void 0 || rt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Pn = Symbol(), Wn = /* @__PURE__ */ new WeakMap();
let Dr = class {
  constructor(e, n, o) {
  ...
  get styleSheet() {
    ...
    if (An && e === void 0) {
      ...
      o && (e = Wn.get(n)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), o && Wn.set(n, e));
    }
    return e;
  }
  toString() {
...
const po = (t) => new Dr(typeof t == "string" ? t : t + "", void 0, Pn), B = (t, ...e) => {
  const n = t.length === 1 ? t[0] : e.reduce((o, r, i) => o + ((s) => {
    if (s._$cssResult$ === !0) return s.cssText;
    if (typeof s == "number") return s;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + s + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(r) + t[i + 1], t[0]);
  return new Dr(n, t, Pn);
}, go = (t, e) => {
  An ? t.adoptedStyleSheets = e.map((n) => n instanceof CSSStyleSheet ? n : n.styleSheet) : e.forEach((n) => {
    const o = document.createElement("style"), r = rt.litNonce;
    r !== void 0 && o.setAttribute("nonce", r), o.textContent = n.cssText, t.appendChild(o);
  });
}, Un = An ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((e) => {
  let n = "";
 ...
 */
var xt;
const ot = window, jn = ot.trustedTypes, wo = jn ? jn.emptyScript : "", kn = ot.reactiveElementPolyfillSupport, rn = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? wo : null;
      break;
  ...
  return n;
} }, Nr = (t, e) => e !== t && (e == e || t == t), $t = { attribute: !0, type: String, converter: rn, reflect: !1, hasChanged: Nr }, on = "finalized";
let Ce = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, n, o) {
    return { get() {
      ...
      const i = this[e];
      this[n] = r, this.requestUpdate(e, i, o);
  ...
  static finalize() {
    if (this.hasOwnProperty(on)) return !1;
    this[on] = !0;
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const r of o) n.unshift(Un(r));
    } else e !== void 0 && n.push(Un(e));
    return n;
  }
  static _$Ep(e, n) {
    const o = n.attribute;
  ...
  createRenderRoot() {
    ...
    return go(n, this.constructor.elementStyles), n;
  }
  connectedCallback() {
    var e;
  ...
  _$EO(e, n, o = $t) {
    ...
    if (i !== void 0 && o.reflect === !0) {
      const s = (((r = o.converter) === null || r === void 0 ? void 0 : r.toAttribute) !== void 0 ? o.converter : rn).toAttribute(n, o.type);
  ...
  _$AK(e, n) {
    ...
    if (i !== void 0 && this._$El !== i) {
      const s = r.getPropertyOptions(i), l = typeof s.converter == "function" ? { fromAttribute: s.converter } : ((o = s.converter) === null || o === void 0 ? void 0 : o.fromAttribute) !== void 0 ? s.converter : rn;
      this._$El = i, this[i] = l.fromAttribute(n, s.type), this._$El = null;
    }
  }
  requestUpdate(e, n, o) {
    let r = !0;
    e !== void 0 && (((o = o || this.constructor.getPropertyOptions(e)).hasChanged || Nr)(this[e], n) ? (this._$AL.has(e) || this._$AL.set(e, n), o.reflect === !0 && this._$El !== e && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(e, o))) : r = !1), !this.isUpdatePending && r && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
  ...
  performUpdate() {
    ...
    const o = this._$AL;
    try {
      n = this.shouldUpdate(o), n ? (this.willUpdate(o), (e = this._$ES) === null || e === void 0 || e.forEach((r) => {
        var i;
...
Ce[on] = !0, Ce.elementProperties = /* @__PURE__ */ new Map(), Ce.elementStyles = [], Ce.shadowRootOptions = { mode: "open" }, kn == null || kn({ ReactiveElement: Ce }), ((xt = ot.reactiveElementVersions) !== null && xt !== void 0 ? xt : ot.reactiveElementVersions = []).push("1.6.3");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var Ct;
const it = window, Oe = it.trustedTypes, Hn = Oe ? Oe.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, sn = "$lit$", ne = `lit$${(Math.random() + "").slice(9)}$`, Lr = "?" + ne, vo = `<${Lr}>`, me = document, ke = () => me.createComment(""), He = (t) => t === null || typeof t != "object" && typeof t != "function", Br = Array.isArray, bo = (t) => Br(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", _t = `[ 	
\f\r]`, Be = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Fn = /-->/g, zn = />/g, de = RegExp(`>|${_t}(?:([^\\s"'>=/]+)(${_t}*=${_t}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), qn = /'/g, Vn = /"/g, Wr = /^(?:script|style|textarea|title)$/i, Ur = (t) => (e, ...n) => ({ _$litType$: t, strings: e, values: n }), f = Ur(1), j = Ur(2), pe = Symbol.for("lit-noChange"), H = Symbol.for("lit-nothing"), Zn = /* @__PURE__ */ new WeakMap(), ue = me.createTreeWalker(me, 129, null, !1);
function jr(t, e) {
...
const yo = (t, e) => {
  ...
  let r, i = e === 2 ? "<svg>" : "", s = Be;
  for (let l = 0; l < n; l++) {
    const a = t[l];
    let c, h, w = -1, d = 0;
    for (; d < a.length && (s.lastIndex = d, h = s.exec(a), h !== null); ) d = s.lastIndex, s === Be ? h[1] === "!--" ? s = Fn : h[1] !== void 0 ? s = zn : h[2] !== void 0 ? (Wr.test(h[2]) && (r = RegExp("</" + h[2], "g")), s = de) : h[3] !== void 0 && (s = de) : s === de ? h[0] === ">" ? (s = r ?? Be, w = -1) : h[1] === void 0 ? w = -2 : (w = s.lastIndex - h[2].length, c = h[1], s = h[3] === void 0 ? de : h[3] === '"' ? Vn : qn) : s === Vn || s === qn ? s = de : s === Fn || s === zn ? s = Be : (s = de, r = void 0);
    const u = s === de && t[l + 1].startsWith("/>") ? " " : "";
    i += s === Be ? a + vo : w >= 0 ? (o.push(c), a.slice(0, w) + sn + a.slice(w) + ne + u) : a + ne + (w === -2 ? (o.push(void 0), l) : u);
  }
  return [jr(t, i + (t[n] || "<?>") + (e === 2 ? "</svg>" : "")), o];
};
class Fe {
  constructor({ strings: e, _$litType$: n }, o) {
    ...
    this.parts = [];
    let i = 0, s = 0;
    const l = e.length - 1, a = this.parts, [c, h] = yo(e, n);
    if (this.el = Fe.createElement(c, o), ue.currentNode = this.el.content, n === 2) {
      const w = this.el.content, d = w.firstChild;
      d.remove(), w.append(...d.childNodes);
    }
    for (; (r = ue.nextNode()) !== null && a.length < l; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) {
          const w = [];
          for (const d of r.getAttributeNames()) if (d.endsWith(sn) || d.startsWith(ne)) {
            const u = h[s++];
            if (w.push(d), u !== void 0) {
              const b = r.getAttribute(u.toLowerCase() + sn).split(ne), g = /([.?@])?(.*)/.exec(u);
              a.push({ type: 1, index: i, name: g[2], strings: b, ctor: g[1] === "." ? $o : g[1] === "?" ? _o : g[1] === "@" ? Eo : mt });
            } else a.push({ type: 6, index: i });
          }
          for (const d of w) r.removeAttribute(d);
        }
        if (Wr.test(r.tagName)) {
          const w = r.textContent.split(ne), d = w.length - 1;
          if (d > 0) {
            r.textContent = Oe ? Oe.emptyScript : "";
            for (let u = 0; u < d; u++) r.append(w[u], ke()), ue.nextNode(), a.push({ type: 2, index: ++i });
            r.append(w[d], ke());
          }
        }
      } else if (r.nodeType === 8) if (r.data === Lr) a.push({ type: 2, index: i });
      else {
        let w = -1;
        for (; (w = r.data.indexOf(ne, w + 1)) !== -1; ) a.push({ type: 7, index: i }), w += ne.length - 1;
      }
      i++;
    }
  }
...
function Ie(t, e, n = t, o) {
  var r, i, s, l;
  if (e === pe) return e;
  let a = o !== void 0 ? (r = n._$Co) === null || r === void 0 ? void 0 : r[o] : n._$Cl;
  const c = He(e) ? void 0 : e._$litDirective$;
  return (a == null ? void 0 : a.constructor) !== c && ((i = a == null ? void 0 : a._$AO) === null || i === void 0 || i.call(a, !1), c === void 0 ? a = void 0 : (a = new c(t), a._$AT(t, n, o)), o !== void 0 ? ((s = (l = n)._$Co) !== null && s !== void 0 ? s : l._$Co = [])[o] = a : n._$Cl = a), a !== void 0 && (e = Ie(t, a._$AS(t, e.values), a, o)), e;
}
class xo {
  constructor(e, n) {
  ...
  u(e) {
    var n;
    const { el: { content: o }, parts: r } = this._$AD, i = ((n = e == null ? void 0 : e.creationScope) !== null && n !== void 0 ? n : me).importNode(o, !0);
    ue.currentNode = i;
    let s = ue.nextNode(), l = 0, a = 0, c = r[0];
    for (; c !== void 0; ) {
      if (l === c.index) {
        let h;
        c.type === 2 ? h = new Ye(s, s.nextSibling, this, e) : c.type === 1 ? h = new c.ctor(s, c.name, c.strings, this, e) : c.type === 6 && (h = new Ao(s, this, e)), this._$AV.push(h), c = r[++a];
      }
...
class Ye {
  constructor(e, n, o, r) {
    var i;
    this.type = 2, this._$AH = H, this._$AN = void 0, this._$AA = e, this._$AB = n, this._$AM = o, this.options = r, this._$Cp = (i = r == null ? void 0 : r.isConnected) === null || i === void 0 || i;
  }
  get _$AU() {
    var e, n;
  ...
  _$AI(e, n = this) {
    e = Ie(this, e, n), He(e) ? e === H || e == null || e === "" ? (this._$AH !== H && this._$AR(), this._$AH = H) : e !== this._$AH && e !== pe && this._(e) : e._$litType$ !== void 0 ? this.g(e) : e.nodeType !== void 0 ? this.$(e) : bo(e) ? this.T(e) : this._(e);
  }
  k(e) {
  ...
  _(e) {
    this._$AH !== H && He(this._$AH) ? this._$AA.nextSibling.data = e : this.$(me.createTextNode(e)), this._$AH = e;
  }
  g(e) {
    var n;
    const { values: o, _$litType$: r } = e, i = typeof r == "number" ? this._$AC(e) : (r.el === void 0 && (r.el = Fe.createElement(jr(r.h, r.h[0]), this.options)), r);
    if (((n = this._$AH) === null || n === void 0 ? void 0 : n._$AD) === i) this._$AH.v(o);
    else {
  ...
  _$AC(e) {
    let n = Zn.get(e.strings);
    return n === void 0 && Zn.set(e.strings, n = new Fe(e)), n;
  }
  T(e) {
    Br(this._$AH) || (this._$AH = [], this._$AR());
    const n = this._$AH;
    let o, r = 0;
    for (const i of e) r === n.length ? n.push(o = new Ye(this.k(ke()), this.k(ke()), this, this.options)) : o = n[r], o._$AI(i), r++;
...
class mt {
  constructor(e, n, o, r, i) {
    this.type = 1, this._$AH = H, this._$AN = void 0, this.element = e, this.name = n, this._$AM = r, this.options = i, o.length > 2 || o[0] !== "" || o[1] !== "" ? (this._$AH = Array(o.length - 1).fill(new String()), this.strings = o) : this._$AH = H;
  }
  get tagName() {
  ...
  _$AI(e, n = this, o, r) {
    ...
    let s = !1;
    if (i === void 0) e = Ie(this, e, n, 0), s = !He(e) || e !== this._$AH && e !== pe, s && (this._$AH = e);
    else {
      const l = e;
      let a, c;
      for (e = i[0], a = 0; a < i.length - 1; a++) c = Ie(this, l[o + a], n, a), c === pe && (c = this._$AH[a]), s || (s = !He(c) || c !== this._$AH[a]), c === H ? e = H : e !== H && (e += (c ?? "") + i[a + 1]), this._$AH[a] = c;
    }
    s && !r && this.j(e);
  }
  j(e) {
...
const Co = Oe ? Oe.emptyScript : "";
class _o extends mt {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(e) {
    e && e !== H ? this.element.setAttribute(this.name, Co) : this.element.removeAttribute(this.name);
  }
}
class Eo extends mt {
  constructor(e, n, o, r, i) {
  ...
  _$AI(e, n = this) {
    var o;
    if ((e = (o = Ie(this, e, n, 0)) !== null && o !== void 0 ? o : H) === pe) return;
...
const Kn = it.litHtmlPolyfillSupport;
Kn == null || Kn(Fe, Ye), ((Ct = it.litHtmlVersions) !== null && Ct !== void 0 ? Ct : it.litHtmlVersions = []).push("2.8.0");
const Po = (t, e, n) => {
  var o, r;
  const i = (o = n == null ? void 0 : n.renderBefore) !== null && o !== void 0 ? o : e;
  let s = i._$litPart$;
  if (s === void 0) {
    const l = (r = n == null ? void 0 : n.renderBefore) !== null && r !== void 0 ? r : null;
    i._$litPart$ = s = new Ye(e.insertBefore(ke(), l), l, void 0, n ?? {});
  }
  return s._$AI(t), s;
};
/**
...
class S extends Ce {
  ...
  update(e) {
    const n = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = Po(n, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const L = (t) => (e) => typeof e == "function" ? ((n, o) => (customElements.define(n, o), o))(t, e) : ((n, o) => {
  const { kind: r, elements: i } = o;
  return { kind: r, elements: i, finisher(s) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Oo = (t, e) => e.kind === "method" && e.descriptor && !("value" in e.descriptor) ? { ...e, finisher(n) {
...
function M(t) {
  return (e, n) => n !== void 0 ? Io(t, e, n) : Oo(t, e);
}
/**
 * @license
 * Copyright 2017 Google LLC
...
const X = Ro(class extends Mo {
  ...
  update(t, [e]) {
    ...
    if (this.it === void 0) {
      ...
      for (const i in e) e[i] && !(!((n = this.nt) === null || n === void 0) && n.has(i)) && this.it.add(i);
    ...
    for (const i in e) {
      const s = !!e[i];
      s === this.it.has(i) || !((o = this.nt) === null || o === void 0) && o.has(i) || (s ? (r.add(i), this.it.add(i)) : (r.remove(i), this.it.delete(i)));
    }
    return pe;
  }
});
...
const kr = (t, e, n) => Math.min(Math.max(n, t), e), V = {
  duration: 0.3,
  delay: 0,
  endDelay: 0,
  repeat: 0,
  easing: "ease"
}, st = (t) => typeof t == "number", Ee = (t) => Array.isArray(t) && !st(t[0]), Do = (t, e, n) => {
  const o = e - t;
  return ((n - t) % o + o) % o + t;
};
function No(t, e) {
...
const Hr = (t, e, n) => -n * t + n * e + t, Fr = () => {
}, oe = (t) => t, On = (t, e, n) => e - t === 0 ? 1 : (n - t) / (e - t);
function zr(t, e) {
...
function Bo(t, e = Lo(t.length), n = oe) {
  const o = t.length, r = o - e.length;
  return r > 0 && zr(e, r), (i) => {
    let s = 0;
    for (; s < o - 2 && !(i < e[s + 1]); s++)
      ;
    let l = kr(0, 1, On(e[s], e[s + 1], i));
    return l = No(n, s)(l), Hr(t[s], t[s + 1], l);
  };
}
const qr = (t) => Array.isArray(t) && st(t[0]), ln = (t) => typeof t == "object" && !!t.createAnimation, Te = (t) => typeof t == "function", Wo = (t) => typeof t == "string", je = {
  ms: (t) => t * 1e3,
  s: (t) => t / 1e3
}, Vr = (t, e, n) => (((1 - 3 * n + 3 * e) * t + (3 * n - 6 * e)) * t + 3 * e) * t, Uo = 1e-7, jo = 12;
function ko(t, e, n, o, r) {
  let i, s, l = 0;
  do
    s = e + (n - e) / 2, i = Vr(s, o, r) - t, i > 0 ? n = s : e = s;
...
function Ue(t, e, n, o) {
  if (t === e && n === o)
    return oe;
  const r = (i) => ko(i, 0, 1, t, n);
  return (i) => i === 0 || i === 1 ? i : Vr(r(i), e, o);
}
const Ho = (t, e = "end") => (n) => {
  n = e === "end" ? Math.min(n, 0.999) : Math.max(n, 1e-3);
  const o = n * t, r = e === "end" ? Math.floor(o) : Math.ceil(o);
  return kr(0, 1, r / t);
}, Fo = {
...
class Zr {
  constructor(e, n = [0, 1], { easing: o, duration: r = V.duration, delay: i = V.delay, endDelay: s = V.endDelay, repeat: l = V.repeat, offset: a, direction: c = "normal", autoplay: h = !0 } = {}) {
    if (this.startTime = null, this.rate = 1, this.t = 0, this.cancelTimestamp = null, this.easing = oe, this.duration = 0, this.totalDuration = 0, this.repeat = 0, this.playState = "idle", this.finished = new Promise((d, u) => {
      ...
      const d = o.createAnimation(n);
      o = d.easing, n = d.keyframes || n, r = d.duration || r;
    }
    this.repeat = l, this.easing = Ee(o) ? oe : Gn(o), this.updateDuration(r);
    const w = Bo(n, a, Ee(o) ? o.map(Gn) : oe);
    this.tick = (d) => {
      var u;
      i = i;
      let b = 0;
...
process.env.NODE_ENV !== "production" && (an = function(t, e) {
  if (!t)
    throw new Error(e);
});
class qo {
...
const Zo = ["", "X", "Y", "Z"], Ko = ["translate", "scale", "rotate", "skew"], lt = {
  x: "translateX",
  y: "translateY",
  z: "translateZ"
}, Qn = {
  ...
  skew: Qn
}, ze = /* @__PURE__ */ new Map(), In = (t) => `--motion-${t}`, at = ["x", "y", "z"];
Ko.forEach((t) => {
  Zo.forEach((e) => {
    at.push(t + e), ze.set(In(t + e), Yo[t]);
  });
});
const Go = (t, e) => at.indexOf(t) - at.indexOf(e), Qo = new Set(at), Yr = (t) => Qo.has(t), Jo = (t, e) => {
  lt[e] && (e = lt[e]);
  const { transforms: n } = Kr(t);
  So(n, e), t.style.transform = Xo(n);
}, Xo = (t) => t.sort(Go).reduce(ei, "").trim(), ei = (t, e) => `${t} ${e}(var(${In(e)}))`, cn = (t) => t.startsWith("--"), Jn = /* @__PURE__ */ new Set();
function ti(t) {
  if (!Jn.has(t)) {
    Jn.add(t);
    try {
      const { syntax: e, initialValue: n } = ze.has(t) ? ze.get(t) : {};
...
const It = (t, e) => document.createElement("div").animate(t, e), Xn = {
...
for (const t in Xn)
  _e[t] = () => (Tt[t] === void 0 && (Tt[t] = Xn[t]()), Tt[t]);
const ni = 0.015, ri = (t, e) => {
  let n = "";
  const o = Math.round(e / ni);
  for (let r = 0; r < o; r++)
    n += t(On(0, o - 1, r)) + ", ";
  return n.substring(0, n.length - 2);
}, er = (t, e) => Te(t) ? _e.linearEasing() ? `linear(${ri(t, e)})` : V.easing : qr(t) ? oi(t) : t, oi = ([t, e, n, o]) => `cubic-bezier(${t}, ${e}, ${n}, ${o})`;
function ii(t, e) {
...
function dn(t) {
  return lt[t] && (t = lt[t]), Yr(t) ? In(t) : t;
}
const et = {
  get: (t, e) => {
    e = dn(e);
    let n = cn(e) ? t.style.getPropertyValue(e) : getComputedStyle(t)[e];
    if (!n && n !== 0) {
      const o = ze.get(e);
      o && (n = o.initialValue);
    }
  ...
  set: (t, e, n) => {
    e = dn(e), cn(e) ? t.style.setProperty(e, n) : t.style[e] = n;
  }
};
function Gr(t, e = !0) {
...
function ci(t, e, n, o = {}, r) {
  ...
  let $ = _e.waapi();
  y && Jo(t, e);
  const W = dn(e), x = Vo(E.values, W), _ = ze.get(W);
  return Gr(x.animation, !(ln(d) && x.generator) && o.record !== !1), () => {
    const A = () => {
      var v, P;
      return (P = (v = et.get(t, W)) !== null && v !== void 0 ? v : _ == null ? void 0 : _.initialValue) !== null && P !== void 0 ? P : 0;
    };
    let m = ii(si(n), A);
    const I = li(m, _);
    if (ln(d)) {
      const v = d.createAnimation(m, e !== "opacity", A, W, x);
      d = v.easing, m = v.keyframes || m, a = v.duration || a;
    }
    if (cn(W) && (_e.cssRegisterProperty() ? ti(W) : $ = !1), y && !_e.linearEasing() && (Te(d) || Ee(d) && d.some(Te)) && ($ = !1), $) {
      _ && (m = m.map((C) => st(C) ? _.toDefaultUnit(C) : C)), m.length === 1 && (!_e.partialKeyframes() || s) && m.unshift(A());
      const v = {
        delay: je.ms(c),
        duration: je.ms(a),
        endDelay: je.ms(h),
        easing: Ee(d) ? void 0 : er(d, a),
        direction: b,
        iterations: w + 1,
        fill: "both"
      };
      l = t.animate({
        [W]: m,
        offset: g,
        easing: Ee(d) ? d.map((C) => er(C, a)) : void 0
      }, v), l.finished || (l.finished = new Promise((C, R) => {
        l.onfinish = C, l.oncancel = R;
      }));
      const P = m[m.length - 1];
      l.finished.then(() => {
        u || (et.set(t, W, P), l.cancel());
      }).catch(Fr), D || (l.playbackRate = 1.000001);
    } else if (y)
      m = m.map((v) => typeof v == "string" ? parseFloat(v) : v), m.length === 1 && m.unshift(parseFloat(A())), l = new r((v) => {
        et.set(t, W, I ? I(v) : v);
...
const hi = (t) => t(), Qr = (t, e, n = V.duration) => new Proxy({
  animations: t.map(hi).filter(Boolean),
  duration: n,
  options: e
}, mi), fi = (t) => t.animations[0], mi = {
  get: (t, e) => {
    const n = fi(t);
    switch (e) {
      case "duration":
        return t.duration;
      case "currentTime":
        return je.s((n == null ? void 0 : n[e]) || 0);
      case "playbackRate":
      case "playState":
        return n == null ? void 0 : n[e];
      case "finished":
        return t.finished || (t.finished = Promise.all(t.animations.map(pi)).catch(Fr)), t.finished;
      case "stop":
        return () => {
          t.animations.forEach((o) => Gr(o));
        };
      case "forEachNative":
        return (o) => {
          t.animations.forEach((r) => o(r, t));
        };
      default:
        return typeof (n == null ? void 0 : n[e]) > "u" ? void 0 : () => t.animations.forEach((o) => o[e]());
    }
  },
  set: (t, e, n) => {
    switch (e) {
...
function wi(t) {
  return function(n, o, r = {}) {
    n = ui(n);
    const i = n.length;
    an(!!i, "No valid element provided."), an(!!o, "No keyframes defined.");
    const s = [];
    for (let l = 0; l < i; l++) {
      const a = n[l];
      for (const c in o) {
        const h = di(r, c);
        h.delay = gi(h.delay, l, i);
        const w = ci(a, c, o[c], h, t);
        s.push(w);
      }
    }
    return Qr(
...
function $i() {
  ...
  return t.prototype.set = function(e, n, o, r) {
...
function Ci() {
  return sr || (sr = 1, function(t) {
    ...
    t.getRowColCoords = function(o) {
      if (o === 1) return [];
      const r = Math.floor(o / 7) + 2, i = e(o), s = i === 145 ? 26 : Math.ceil((i - 13) / (2 * r - 2)) * 2, l = [i - 7];
      for (let a = 1; a < r - 1; a++)
        l[a] = l[a - 1] - s;
  ...
  return ar || (ar = 1, function(t) {
    ...
    t.isValid = function(r) {
      ...
      for (let w = 0; w < i; w++) {
        ...
        for (let d = 0; d < i; d++) {
          let u = r.get(w, d);
          u === c ? l++ : (l >= 5 && (s += e.N1 + (l - 5)), c = u, l = 1), u = r.get(d, w), u === h ? a++ : (a >= 5 && (s += e.N1 + (a - 5)), h = u, a = 1);
        }
      ...
      for (let c = 0; c < i; c++) {
        l = a = 0;
        for (let h = 0; h < i; h++)
          l = l << 1 & 2047 | r.get(c, h), h >= 10 && (l === 1488 || l === 93) && s++, a = a << 1 & 2047 | r.get(h, c), h >= 10 && (a === 1488 || a === 93) && s++;
      }
      return s * e.N3;
    ...
    t.applyMask = function(r, i) {
      ...
      for (let c = 0; c < s; c++) {
        i(c), t.applyMask(c, r);
        const h = t.getPenaltyN1(r) + t.getPenaltyN2(r) + t.getPenaltyN3(r) + t.getPenaltyN4(r);
        t.applyMask(c, r), h < a && (a = h, l = c);
      }
      return l;
    };
  }(Wt)), Wt;
...
function Jr() {
  ...
  return tt.getBlocksCount = function(r, i) {
    switch (i) {
      case t.L:
        return e[(r - 1) * 4 + 0];
      case t.M:
  ...
  }, tt.getTotalCodewordsCount = function(r, i) {
    switch (i) {
      case t.L:
        return n[(r - 1) * 4 + 0];
      case t.M:
...
function Oi() {
  ...
  return e.prototype.initialize = function(o) {
    ...
    r.set(o);
    const i = t.mod(r, this.genPoly), s = this.degree - i.length;
    if (s > 0) {
...
var kt = {}, Ht = {}, Ft = {}, fr;
function Xr() {
  return fr || (fr = 1, Ft.isValid = function(e) {
...
function eo() {
  ...
  Z.KANJI = new RegExp(n, "g"), Z.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g"), Z.BYTE = new RegExp(o, "g"), Z.NUMERIC = new RegExp(t, "g"), Z.ALPHANUMERIC = new RegExp(e, "g");
  const r = new RegExp("^" + n + "$"), i = new RegExp("^" + t + "$"), s = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
function Ii() {
  return gr || (gr = 1, function(t) {
    const e = be(), n = Jr(), o = Tn(), r = ye(), i = Xr(), s = 7973, l = e.getBCHDigit(s);
    function a(d, u, b) {
      for (let g = 1; g <= 40; g++)
    ...
    function w(d, u) {
      for (let b = 1; b <= 40; b++)
        if (h(d, b) <= t.getCapacity(b, u, r.MIXED))
          return b;
    }
    t.from = function(u, b) {
      ...
      typeof g > "u" && (g = r.BYTE);
      const D = e.getSymbolTotalCodewords(u), p = n.getTotalCodewordsCount(u, b), E = (D - p) * 8;
      if (g === r.MIXED) return E;
      const y = E - c(g, u);
      switch (g) {
        case r.NUMERIC:
...
function Ti() {
  if (wr) return zt;
  wr = 1;
  const t = be(), e = 1335, n = 21522, o = t.getBCHDigit(e);
...
function Ri() {
  ...
  return e.getBitsLength = function(o) {
    ...
    l > 0 && (i = this.data.substr(r), s = parseInt(i, 10), o.put(s, l * 3 + 1));
  }, Vt = e, Vt;
}
var Zt, br;
function Mi() {
...
function Di() {
  ...
  return n.getBitsLength = function(r) {
    ...
    for (let r = 0, i = this.data.length; r < i; r++)
      o.put(this.data[r], 8);
  }, Yt = n, Yt;
}
var Gt, $r;
...
function Li() {
  return Cr || (Cr = 1, function(t) {
    const e = ye(), n = Ri(), o = Mi(), r = Di(), i = Ni(), s = eo(), l = be(), a = fo();
    function c(p) {
    ...
    function w(p) {
      ...
      let $, W;
      return l.isKanjiModeEnabled() ? ($ = h(s.BYTE, e.BYTE, p), W = h(s.KANJI, e.KANJI, p)) : ($ = h(s.BYTE_KANJI, e.BYTE, p), W = []), E.concat(y, $, W).sort(function(_, A) {
      ...
      for (let x = 0; x < p.length; x++) {
        ...
        for (let m = 0; m < _.length; m++) {
          ...
          for (let P = 0; P < W.length; P++) {
            const C = W[P];
            y[C] && y[C].node.mode === I.mode ? ($[C][v] = d(y[C].lastCount + I.length, I.mode) - d(y[C].lastCount, I.mode), y[C].lastCount += I.length) : (y[C] && (y[C].lastCount = I.length), $[C][v] = d(I.length, I.mode) + 4 + e.getCharCountIndicator(I.mode, E));
          }
        }
        W = A;
      }
 ...
 Suggested mode is: ` + e.toString($));
    ...
    t.fromArray = function(E) {
      ...
      const $ = w(E, l.isKanjiModeEnabled()), W = b($), x = g(W, y), _ = a.find_path(x.map, "start", "end"), A = [];
      for (let m = 1; m < _.length - 1; m++)
        A.push(x.table[_[m]].node);
...
function Bi() {
  if (_r) return Mt;
  _r = 1;
  const t = be(), e = Tn(), n = xi(), o = $i(), r = Ci(), i = _i(), s = Ei(), l = Jr(), a = Oi(), c = Ii(), h = Ti(), w = ye(), d = Li();
  function u(x, _) {
    const A = x.size, m = i.getPositions(_);
    for (let I = 0; I < m.length; I++) {
      const v = m[I][0], P = m[I][1];
      for (let C = -1; C <= 7; C++)
        if (!(v + C <= -1 || A <= v + C))
          for (let R = -1; R <= 7; R++)
            P + R <= -1 || A <= P + R || (C >= 0 && C <= 6 && (R === 0 || R === 6) || R >= 0 && R <= 6 && (C === 0 || C === 6) || C >= 2 && C <= 4 && R >= 2 && R <= 4 ? x.set(v + C, P + R, !0, !0) : x.set(v + C, P + R, !1, !0));
    }
  }
  function b(x) {
    const _ = x.size;
    for (let A = 8; A < _ - 8; A++) {
      const m = A % 2 === 0;
      x.set(A, 6, m, !0), x.set(6, A, m, !0);
    }
  }
  function g(x, _) {
    const A = r.getPositions(_);
    for (let m = 0; m < A.length; m++) {
      const I = A[m][0], v = A[m][1];
      for (let P = -2; P <= 2; P++)
        for (let C = -2; C <= 2; C++)
          P === -2 || P === 2 || C === -2 || C === 2 || P === 0 && C === 0 ? x.set(I + P, v + C, !0, !0) : x.set(I + P, v + C, !1, !0);
    }
  }
  function D(x, _) {
    const A = x.size, m = c.getEncodedBits(_);
    let I, v, P;
    for (let C = 0; C < 18; C++)
      I = Math.floor(C / 3), v = C % 3 + A - 8 - 3, P = (m >> C & 1) === 1, x.set(I, v, P, !0), x.set(v, I, P, !0);
  }
  function p(x, _, A) {
    const m = x.size, I = h.getEncodedBits(_, A);
    let v, P;
    for (v = 0; v < 15; v++)
      P = (I >> v & 1) === 1, v < 6 ? x.set(v, 8, P, !0) : v < 8 ? x.set(v + 1, 8, P, !0) : x.set(m - 15 + v, 8, P, !0), v < 8 ? x.set(8, m - v - 1, P, !0) : v < 9 ? x.set(8, 15 - v - 1 + 1, P, !0) : x.set(8, 15 - v - 1, P, !0);
    x.set(m - 8, 8, 1, !0);
  }
  function E(x, _) {
    const A = x.size;
    let m = -1, I = A - 1, v = 7, P = 0;
    for (let C = A - 1; C > 0; C -= 2)
      for (C === 6 && C--; ; ) {
        for (let R = 0; R < 2; R++)
          if (!x.isReserved(I, C - R)) {
            let ee = !1;
            P < _.length && (ee = (_[P] >>> v & 1) === 1), x.set(I, C - R, ee), v--, v === -1 && (P++, v = 7);
          }
        if (I += m, I < 0 || A <= I) {
          I -= m, m = -m;
          break;
  ...
  function y(x, _, A) {
    ...
    A.forEach(function(R) {
      m.put(R.mode.bit, 4), m.put(R.getLength(), w.getCharCountIndicator(R.mode, x)), R.write(m);
    });
    const I = t.getSymbolTotalCodewords(x), v = l.getTotalCodewordsCount(x, _), P = (I - v) * 8;
    for (m.getLengthInBits() + 4 <= P && m.put(0, 4); m.getLengthInBits() % 8 !== 0; )
      m.putBit(0);
    const C = (P - m.getLengthInBits()) / 8;
    for (let R = 0; R < C; R++)
      m.put(R % 2 ? 17 : 236, 8);
    return $(m, x, _);
  }
  function $(x, _, A) {
    const m = t.getSymbolTotalCodewords(_), I = l.getTotalCodewordsCount(_, A), v = m - I, P = l.getBlocksCount(_, A), C = m % P, R = P - C, ee = Math.floor(m / P), Le = Math.floor(v / P), ao = Le + 1, Nn = ee - Le, co = new a(Nn);
    let wt = 0;
    const Xe = new Array(P), Ln = new Array(P);
    let vt = 0;
    const uo = new Uint8Array(x.buffer);
    for (let xe = 0; xe < P; xe++) {
      const yt = xe < R ? Le : ao;
      Xe[xe] = uo.slice(wt, wt + yt), Ln[xe] = co.encode(Xe[xe]), wt += yt, vt = Math.max(vt, yt);
    }
    const bt = new Uint8Array(m);
    let Bn = 0, G, Q;
    for (G = 0; G < vt; G++)
      for (Q = 0; Q < P; Q++)
        G < Xe[Q].length && (bt[Bn++] = Xe[Q][G]);
    for (G = 0; G < Nn; G++)
      for (Q = 0; Q < P; Q++)
        bt[Bn++] = Ln[Q][G];
    return bt;
...
`
    ...
    const P = y(_, A, I), C = t.getSymbolSize(_), R = new o(C);
    return u(R, _), b(R), g(R, _), p(R, A, 0), _ >= 7 && D(R, _), E(R, P), isNaN(m) && (m = s.getBestMask(
      R,
      p.bind(null, R, A)
    )), s.applyMask(m, R), p(R, A, m), {
      modules: R,
      version: _,
  ...
  return Mt.create = function(_, A) {
    if (typeof _ > "u" || _ === "")
      throw new Error("No input text");
    let m = e.M, I, v;
    return typeof A < "u" && (m = e.from(A.errorCorrectionLevel, e.M), I = c.from(A.version), v = s.from(A.maskPattern), A.toSJISFunc && t.setToSJISFunction(A.toSJISFunc)), W(_, I, m, v);
  }, Mt;
}
var Qt = {}, Jt = {}, Er;
function to() {
  return Er || (Er = 1, function(t) {
    ...
    t.getOptions = function(o) {
      ...
      const s = r.modules.size, l = r.modules.data, a = t.getScale(s, i), c = Math.floor((s + i.margin * 2) * a), h = i.margin * a, w = [i.color.light, i.color.dark];
      for (let d = 0; d < c; d++)
        for (let u = 0; u < c; u++) {
...
function Wi() {
  return Ar || (Ar = 1, function(t) {
    ...
    t.render = function(i, s, l) {
      ...
      return e.qrToImageData(d.data, i, a), n(w, c, h), w.putImageData(d, 0, 0), c;
...
function Ui() {
  ...
  function o(r, i, s) {
    ...
    for (let w = 0; w < r.length; w++) {
      ...
      !d && !c && (c = !0), r[w] ? (h++, w > 0 && d > 0 && r[w - 1] || (l += c ? n("M", d + s, 0.5 + u + s) : n("m", a, 0), a = 0, c = !1), d + 1 < i && r[w + 1] || (l += n("h", h), h = 0)) : a++;
    }
    return l;
  }
...
function ji() {
  if (Or) return $e;
  Or = 1;
  const t = yi(), e = Bi(), n = Wi(), o = Ui();
  function r(i, s, l, a, c) {
  ...
  return $e.create = e.create, $e.toCanvas = r.bind(null, n.render), $e.toDataURL = r.bind(null, n.renderToDataURL), $e.toString = r.bind(null, function(i, s, l) {
    return o.render(i, l);
  }), $e;
}
var ki = ji();
const Hi = /* @__PURE__ */ mo(ki);
var Fi = Object.defineProperty, Ir = Object.getOwnPropertySymbols, zi = Object.prototype.hasOwnProperty, qi = Object.prototype.propertyIsEnumerable, Tr = (t, e, n) => e in t ? Fi(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, en = (t, e) => {
  for (var n in e || (e = {}))
    zi.call(e, n) && Tr(t, n, e[n]);
  if (Ir)
    for (var n of Ir(e))
      qi.call(e, n) && Tr(t, n, e[n]);
  return t;
};
function Vi() {
  var t;
...
const N = {
  ...
  setTheme() {
    ...
    if (t) {
      const n = en(en(en({}, Vi()), Rr()), e);
      Object.entries(n).forEach(([o, r]) => t.style.setProperty(o, r));
    }
  },
...
var Ki = Object.defineProperty, Yi = Object.getOwnPropertyDescriptor, Se = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Yi(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Ki(e, n, r), r;
};
...
var Qi = Object.defineProperty, Ji = Object.getOwnPropertyDescriptor, Rn = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Ji(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Qi(e, n, r), r;
};
...
var es = Object.defineProperty, ts = Object.getOwnPropertyDescriptor, ns = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? ts(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && es(e, n, r), r;
};
...
var os = Object.defineProperty, is = Object.getOwnPropertyDescriptor, ss = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? is(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && os(e, n, r), r;
};
let hn = class extends S {
  // -- render ------------------------------------------------------- //
  render() {
    return f`<div class="wcm-toolbar-placeholder"></div><div class="wcm-toolbar">${U.WALLET_CONNECT_LOGO} <button @click="${nt.close}">${U.CROSS_ICON}</button></div>`;
  }
};
hn.styles = [N.globalCss, rs];
hn = ss([
  L("wcm-modal-backcard")
], hn);
const ls = B`main{padding:20px;padding-top:0;width:100%}`;
var as = Object.defineProperty, cs = Object.getOwnPropertyDescriptor, ds = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? cs(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && as(e, n, r), r;
};
...
fn.styles = [N.globalCss, ls];
fn = ds([
  L("wcm-modal-content")
], fn);
const us = B`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}`;
var hs = Object.defineProperty, fs = Object.getOwnPropertyDescriptor, ms = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? fs(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && hs(e, n, r), r;
};
...
mn.styles = [N.globalCss, us];
mn = ms([
  L("wcm-modal-footer")
], mn);
const ps = B`header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}`;
var gs = Object.defineProperty, ws = Object.getOwnPropertyDescriptor, Ge = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? ws(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && gs(e, n, r), r;
};
let ge = class extends S {
  ...
  // -- private ------------------------------------------------------ //
  backBtnTemplate() {
    return f`<button class="wcm-back-btn" @click="${k.goBack}">${U.BACK_ICON}</button>`;
  }
  actionBtnTemplate() {
  ...
  render() {
    ...
    }, e = k.state.history.length > 1, n = this.title ? f`<wcm-text variant="big-bold">${this.title}</wcm-text>` : f`<slot></slot>`;
    return f`<header class="${X(t)}">${e ? this.backBtnTemplate() : null} ${n} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
  }
};
ge.styles = [N.globalCss, ps];
Ge([
  M()
...
const T = {
  ...
  getShadowRootElement(t, e) {
    const n = t.renderRoot.querySelector(e);
    if (!n)
      throw new Error(`${e} not found`);
    return n;
  },
  getWalletIcon({ id: t, image_id: e }) {
    const { walletImages: n } = fe.state;
    return n != null && n[t] ? n[t] : e ? z.getWalletImageUrl(e) : "";
  },
  getWalletName(t, e = !1) {
  ...
  async preloadImage(t) {
    const e = new Promise((n, o) => {
      const r = new Image();
      r.onload = n, r.onerror = o, r.crossOrigin = "anonymous", r.src = t;
    });
  ...
  handleMobileLinking(t, e = "_self") {
    const { walletConnectUri: n } = K.state, { mobile: o, name: r } = t, i = o == null ? void 0 : o.native, s = o == null ? void 0 : o.universal;
    T.setRecentWallet(t);
    function l(a) {
      if (i) {
        const c = O.formatNativeUrl(i, a, r);
        O.openHref(c, e);
      } else if (s) {
        const c = O.formatUniversalUrl(s, a, r);
        O.openHref(c, e);
      }
    }
    n && l(n);
  ...
  async handleUriCopy() {
    ...
    if (t)
      try {
        await navigator.clipboard.writeText(t), re.openToast("Link copied", "success");
      } catch {
        re.openToast("Failed to copy", "error");
      }
  },
  getCustomImageUrls() {
    const { walletImages: t } = fe.state, e = Object.values(t ?? {});
  ...
  getCachedRouterWalletPlatforms() {
    const { desktop: t, mobile: e } = O.getWalletRouterData(), n = !!(t != null && t.native), o = !!(t != null && t.universal), r = !!(e != null && e.native) || !!(e != null && e.universal);
    return { isDesktop: n, isMobile: r, isWeb: o };
  },
  goToConnectingView(t) {
    k.setData({ Wallet: t });
    const e = O.isMobile(), { isDesktop: n, isWeb: o, isMobile: r } = T.getCachedRouterWalletPlatforms();
    e ? r ? (k.push("MobileConnecting"), !O.isAndroid() && O.isTelegram() && this.handleMobileLinking(t, "_blank")) : o ? k.push("WebConnecting") : k.push("InstallWallet") : n ? k.push("DesktopConnecting") : o ? k.push("WebConnecting") : r ? k.push("MobileQrcodeConnecting") : k.push("InstallWallet");
  }
}, vs = B`.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`;
var bs = Object.defineProperty, ys = Object.getOwnPropertyDescriptor, Mn = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? ys(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && bs(e, n, r), r;
};
...
const xs = B`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`;
var $s = Object.defineProperty, Cs = Object.getOwnPropertyDescriptor, no = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Cs(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && $s(e, n, r), r;
};
let ct = class extends S {
  constructor() {
    super(), this.open = !1, this.unsubscribe = void 0, this.timeout = void 0, this.unsubscribe = re.subscribe((t) => {
      t.open ? (this.open = !0, this.timeout = setTimeout(() => re.closeToast(), 2200)) : (this.open = !1, clearTimeout(this.timeout));
    });
  }
  disconnectedCallback() {
    var t;
    (t = this.unsubscribe) == null || t.call(this), clearTimeout(this.timeout), re.closeToast();
  }
  // -- render ------------------------------------------------------- //
  render() {
    const { message: t, variant: e } = re.state, n = {
      "wcm-success": e === "success",
      "wcm-error": e === "error"
    };
    return this.open ? f`<div class="${X(n)}">${e === "success" ? U.CHECKMARK_ICON : null} ${e === "error" ? U.CROSS_ICON : null}<wcm-text variant="small-regular">${t}</wcm-text></div>` : null;
  }
};
ct.styles = [N.globalCss, xs];
no([
  q()
], ct.prototype, "open", 2);
ct = no([
...
const _s = 0.1, Mr = 2.5, J = 7;
function tn(t, e, n) {
  return t === e ? !1 : (t - e < 0 ? e - t : t - e) <= n + _s;
}
function Es(t, e) {
...
const As = {
  generate(t, e, n) {
    const o = "#141414", r = "#ffffff", i = [], s = Es(t, "Q"), l = e / s.length, a = [
      { x: 0, y: 0 },
      { x: 1, y: 0 },
      { x: 0, y: 1 }
    ];
    a.forEach(({ x: b, y: g }) => {
      ...
      for (let y = 0; y < a.length; y += 1) {
        const $ = l * (J - y * 2);
        i.push(
          j`<rect fill="${y % 2 === 0 ? o : r}" height="${$}" rx="${$ * E}" ry="${$ * E}" width="${$}" x="${D + l * y}" y="${p + l * y}">`
        );
      }
    });
    const c = Math.floor((n + 25) / l), h = s.length / 2 - c / 2, w = s.length / 2 + c / 2 - 1, d = [];
    s.forEach((b, g) => {
      b.forEach((D, p) => {
    ...
    return d.forEach(([b, g]) => {
      ...
      const D = g.filter(
        (p) => g.every((E) => !tn(p, E, l))
      );
      return [Number(b), D];
    }).forEach(([b, g]) => {
      g.forEach((D) => {
        i.push(
          j`<circle cx="${b}" cy="${D}" fill="${o}" r="${l / Mr}">`
        );
      });
    }), Object.entries(u).filter(([b, g]) => g.length > 1).map(([b, g]) => {
      const D = g.filter((p) => g.some((E) => tn(p, E, l)));
      return [Number(b), D];
    }).map(([b, g]) => {
      g.sort((p, E) => p < E ? -1 : 1);
      const D = [];
      ...
      g.forEach(([D, p]) => {
        i.push(
          j`<line x1="${b}" x2="${b}" y1="${D}" y2="${p}" stroke="${o}" stroke-width="${l / (Mr / 2)}" stroke-linecap="round">`
        );
      });
    }), i;
  }
}, Ps = B`@keyframes fadeIn{0%{opacity:0}100%{opacity:1}}div{position:relative;user-select:none;display:block;overflow:hidden;aspect-ratio:1/1;animation:fadeIn ease .2s}.wcm-dark{background-color:#fff;border-radius:var(--wcm-container-border-radius);padding:18px;box-shadow:0 2px 5px #000}svg:first-child,wcm-wallet-image{position:absolute;top:50%;left:50%;transform:translateY(-50%) translateX(-50%)}wcm-wallet-image{transform:translateY(-50%) translateX(-50%)}wcm-wallet-image{width:25%;height:25%;border-radius:var(--wcm-wallet-icon-border-radius)}svg:first-child{transform:translateY(-50%) translateX(-50%) scale(.9)}svg:first-child path:first-child{fill:var(--wcm-accent-color)}svg:first-child path:last-child{stroke:var(--wcm-color-overlay)}`;
var Os = Object.defineProperty, Is = Object.getOwnPropertyDescriptor, De = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Is(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Os(e, n, r), r;
};
let le = class extends S {
  ...
  svgTemplate() {
    ...
    return j`<svg height="${e}" width="${e}">${As.generate(this.uri, e, e / 4)}</svg>`;
  }
  // -- render ------------------------------------------------------- //
  render() {
    const t = {
    ...
    return f`<div style="${`width: ${this.size}px`}" class="${X(t)}">${this.walletId || this.imageUrl ? f`<wcm-wallet-image walletId="${F(this.walletId)}" imageId="${F(this.imageId)}" imageUrl="${F(this.imageUrl)}"></wcm-wallet-image>` : U.WALLET_CONNECT_ICON_COLORED} ${this.svgTemplate()}</div>`;
  }
};
le.styles = [N.globalCss, Ps];
De([
  M()
], le.prototype, "uri", 2);
De([
...
const Ts = B`:host{position:relative;height:28px;width:80%}input{width:100%;height:100%;line-height:28px!important;border-radius:var(--wcm-input-border-radius);font-style:normal;font-family:-apple-system,system-ui,BlinkMacSystemFont,'Segoe UI',Roboto,Ubuntu,'Helvetica Neue',sans-serif;font-feature-settings:'case' on;font-weight:500;font-size:16px;letter-spacing:-.03em;padding:0 10px 0 34px;transition:.2s all ease;color:var(--wcm-color-fg-1);background-color:var(--wcm-color-bg-3);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay);caret-color:var(--wcm-accent-color)}input::placeholder{color:var(--wcm-color-fg-2)}svg{left:10px;top:4px;pointer-events:none;position:absolute;width:20px;height:20px}input:focus-within{box-shadow:inset 0 0 0 1px var(--wcm-accent-color)}path{fill:var(--wcm-color-fg-2)}`;
var Rs = Object.defineProperty, Ms = Object.getOwnPropertyDescriptor, ro = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Ms(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Rs(e, n, r), r;
};
let dt = class extends S {
  ...
  // -- render ------------------------------------------------------- //
  render() {
    return f`<input type="text" @input="${this.onChange}" placeholder="Search wallets"> ${U.SEARCH_ICON}`;
  }
};
dt.styles = [N.globalCss, Ts];
ro([
  M()
...
const Ss = B`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--wcm-accent-color)}`;
var Ds = Object.defineProperty, Ns = Object.getOwnPropertyDescriptor, Ls = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Ns(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Ds(e, n, r), r;
};
let pn = class extends S {
  // -- render ------------------------------------------------------- //
  render() {
    return f`<svg viewBox="0 0 50 50" width="24" height="24"><circle cx="25" cy="25" r="20" fill="none" stroke-width="4" stroke="#fff"/></svg>`;
  }
};
pn.styles = [N.globalCss, Ss];
pn = Ls([
  L("wcm-spinner")
], pn);
const Bs = B`span{font-style:normal;font-family:var(--wcm-font-family);font-feature-settings:var(--wcm-font-feature-settings)}.wcm-xsmall-bold{font-family:var(--wcm-text-xsmall-bold-font-family);font-weight:var(--wcm-text-xsmall-bold-weight);font-size:var(--wcm-text-xsmall-bold-size);line-height:var(--wcm-text-xsmall-bold-line-height);letter-spacing:var(--wcm-text-xsmall-bold-letter-spacing);text-transform:var(--wcm-text-xsmall-bold-text-transform)}.wcm-xsmall-regular{font-family:var(--wcm-text-xsmall-regular-font-family);font-weight:var(--wcm-text-xsmall-regular-weight);font-size:var(--wcm-text-xsmall-regular-size);line-height:var(--wcm-text-xsmall-regular-line-height);letter-spacing:var(--wcm-text-xsmall-regular-letter-spacing);text-transform:var(--wcm-text-xsmall-regular-text-transform)}.wcm-small-thin{font-family:var(--wcm-text-small-thin-font-family);font-weight:var(--wcm-text-small-thin-weight);font-size:var(--wcm-text-small-thin-size);line-height:var(--wcm-text-small-thin-line-height);letter-spacing:var(--wcm-text-small-thin-letter-spacing);text-transform:var(--wcm-text-small-thin-text-transform)}.wcm-small-regular{font-family:var(--wcm-text-small-regular-font-family);font-weight:var(--wcm-text-small-regular-weight);font-size:var(--wcm-text-small-regular-size);line-height:var(--wcm-text-small-regular-line-height);letter-spacing:var(--wcm-text-small-regular-letter-spacing);text-transform:var(--wcm-text-small-regular-text-transform)}.wcm-medium-regular{font-family:var(--wcm-text-medium-regular-font-family);font-weight:var(--wcm-text-medium-regular-weight);font-size:var(--wcm-text-medium-regular-size);line-height:var(--wcm-text-medium-regular-line-height);letter-spacing:var(--wcm-text-medium-regular-letter-spacing);text-transform:var(--wcm-text-medium-regular-text-transform)}.wcm-big-bold{font-family:var(--wcm-text-big-bold-font-family);font-weight:var(--wcm-text-big-bold-weight);font-size:var(--wcm-text-big-bold-size);line-height:var(--wcm-text-big-bold-line-height);letter-spacing:var(--wcm-text-big-bold-letter-spacing);text-transform:var(--wcm-text-big-bold-text-transform)}:host(*){color:var(--wcm-color-fg-1)}.wcm-color-primary{color:var(--wcm-color-fg-1)}.wcm-color-secondary{color:var(--wcm-color-fg-2)}.wcm-color-tertiary{color:var(--wcm-color-fg-3)}.wcm-color-inverse{color:var(--wcm-accent-fill-color)}.wcm-color-accnt{color:var(--wcm-accent-color)}.wcm-color-error{color:var(--wcm-error-color)}`;
var Ws = Object.defineProperty, Us = Object.getOwnPropertyDescriptor, Sn = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Us(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Ws(e, n, r), r;
};
...
const js = B`button{width:100%;height:100%;border-radius:var(--wcm-button-hover-highlight-border-radius);display:flex;align-items:flex-start}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}button>div{width:80px;padding:5px 0;display:flex;flex-direction:column;align-items:center}wcm-text{width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center}wcm-wallet-image{height:60px;width:60px;transition:all .2s ease;border-radius:var(--wcm-wallet-icon-border-radius);margin-bottom:5px}.wcm-sublabel{margin-top:2px}`;
var ks = Object.defineProperty, Hs = Object.getOwnPropertyDescriptor, ce = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Hs(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && ks(e, n, r), r;
};
...
const Fs = B`:host{display:block}div{overflow:hidden;position:relative;border-radius:inherit;width:100%;height:100%;background-color:var(--wcm-color-overlay)}svg{position:relative;width:100%;height:100%}div::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;border-radius:inherit;border:1px solid var(--wcm-color-overlay)}div img{width:100%;height:100%;object-fit:cover;object-position:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
var zs = Object.defineProperty, qs = Object.getOwnPropertyDescriptor, pt = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? qs(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && zs(e, n, r), r;
};
let Re = class extends S {
  ...
  render() {
    ...
    return f`${e.length ? f`<div><img crossorigin="anonymous" src="${e}" alt="${this.id}"></div>` : U.WALLET_PLACEHOLDER}`;
  }
};
Re.styles = [N.globalCss, Fs];
pt([
  M()
...
var Vs = Object.defineProperty, Zs = Object.getOwnPropertyDescriptor, oo = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Zs(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Vs(e, n, r), r;
};
let gn = class extends S {
  ...
  async preloadListings() {
    if (fe.state.enableExplorer) {
      await z.getRecomendedWallets(), K.setIsDataLoaded(!0);
      const { recomendedWallets: t } = z.state, e = t.map((n) => T.getWalletIcon(n));
  ...
  async preloadData() {
    try {
      ...
      console.error(t), re.openToast("Failed preloading", "error");
    }
  }
};
oo([
  q()
], gn.prototype, "preload", 2);
gn = oo([
  L("wcm-explorer-context")
], gn);
var Ks = Object.defineProperty, Ys = Object.getOwnPropertyDescriptor, Gs = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Ys(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Ks(e, n, r), r;
};
let Sr = class extends S {
  // -- lifecycle ---------------------------------------------------- //
  constructor() {
...
var Js = Object.defineProperty, Xs = Object.getOwnPropertyDescriptor, el = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Xs(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Js(e, n, r), r;
};
let wn = class extends S {
  ...
  // -- render ------------------------------------------------------- //
  render() {
    const { recomendedWallets: t } = z.state, e = [...t, ...t], n = O.RECOMMENDED_WALLET_AMOUNT * 2;
    return f`<wcm-modal-header title="Connect your wallet" .onAction="${this.onGoToQrcode}" .actionIcon="${U.QRCODE_ICON}"></wcm-modal-header><wcm-modal-content><div class="wcm-title">${U.MOBILE_ICON}<wcm-text variant="small-regular" color="accent">WalletConnect</wcm-text></div><div class="wcm-slider"><div class="wcm-track">${[...Array(n)].map((o, r) => {
      const i = e[r % e.length];
      return i ? f`<wcm-wallet-image walletId="${i.id}" imageId="${i.image_id}"></wcm-wallet-image>` : U.WALLET_PLACEHOLDER;
...
wn.styles = [N.globalCss, Qs];
wn = el([
  L("wcm-android-wallet-selection")
], wn);
const tl = B`@keyframes loading{to{stroke-dashoffset:0}}@keyframes shake{10%,90%{transform:translate3d(-1px,0,0)}20%,80%{transform:translate3d(1px,0,0)}30%,50%,70%{transform:translate3d(-2px,0,0)}40%,60%{transform:translate3d(2px,0,0)}}:host{display:flex;flex-direction:column;align-items:center}div{position:relative;width:110px;height:110px;display:flex;justify-content:center;align-items:center;margin:40px 0 20px 0;transform:translate3d(0,0,0)}svg{position:absolute;width:110px;height:110px;fill:none;stroke:transparent;stroke-linecap:round;stroke-width:2px;top:0;left:0}use{stroke:var(--wcm-accent-color);animation:loading 1s linear infinite}wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:90px;height:90px}wcm-text{margin-bottom:40px}.wcm-error svg{stroke:var(--wcm-error-color)}.wcm-error use{display:none}.wcm-error{animation:shake .4s cubic-bezier(.36,.07,.19,.97) both}.wcm-stale svg,.wcm-stale use{display:none}`;
var nl = Object.defineProperty, rl = Object.getOwnPropertyDescriptor, Ne = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? rl(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && nl(e, n, r), r;
};
let ae = class extends S {
  ...
  svgLoaderTemplate() {
    ...
    return f`<svg viewBox="0 0 110 110" width="110" height="110"><rect id="wcm-loader" x="2" y="2" width="106" height="106" rx="${s}"/><use xlink:href="#wcm-loader" stroke-dasharray="106 ${l}" stroke-dashoffset="${a}"></use></svg>`;
  }
  // -- render ------------------------------------------------------- //
  render() {
    const t = {
...
const Ae = {
  manualWallets() {
    var t, e;
    const { mobileWallets: n, desktopWallets: o } = fe.state, r = (t = Ae.recentWallet()) == null ? void 0 : t.id, i = O.isMobile() ? n : o, s = i == null ? void 0 : i.filter((l) => r !== l.id);
  ...
  recomendedWallets(t = !1) {
    var e;
    const n = t || (e = Ae.recentWallet()) == null ? void 0 : e.id, { recomendedWallets: o } = z.state;
    return o.filter((i) => n !== i.id);
  }
}, ie = {
  onConnecting(t) {
  ...
  recomendedWalletsTemplate(t = !1) {
    return Ae.recomendedWallets(t).map(
      (n) => f`<wcm-wallet-button name="${n.name}" walletId="${n.id}" imageId="${n.image_id}" .onClick="${() => this.onConnecting(n)}"></wcm-wallet-button>`
    );
  },
...
}, ol = B`.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between}.wcm-desktop-title,.wcm-mobile-title{display:flex;align-items:center}.wcm-mobile-title{justify-content:space-between;margin-bottom:20px;margin-top:-10px}.wcm-desktop-title{margin-bottom:10px;padding:0 10px}.wcm-subtitle{display:flex;align-items:center}.wcm-subtitle:last-child path{fill:var(--wcm-color-fg-3)}.wcm-desktop-title svg,.wcm-mobile-title svg{margin-right:6px}.wcm-desktop-title path,.wcm-mobile-title path{fill:var(--wcm-accent-color)}`;
var il = Object.defineProperty, sl = Object.getOwnPropertyDescriptor, ll = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? sl(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && il(e, n, r), r;
};
let vn = class extends S {
  // -- render ------------------------------------------------------- //
  render() {
    const { explorerExcludedWalletIds: t, enableExplorer: e } = fe.state, n = t !== "ALL" && e, o = ie.manualWalletsTemplate(), r = ie.recomendedWalletsTemplate();
    let s = [ie.recentWalletTemplate(), ...o, ...r];
    s = s.filter(Boolean);
    const l = s.length > 4 || n;
    let a = [];
    l ? a = s.slice(0, 3) : a = s;
    const c = !!a.length;
    return f`<wcm-modal-header .border="${!0}" title="Connect your wallet" .onAction="${T.handleUriCopy}" .actionIcon="${U.COPY_ICON}"></wcm-modal-header><wcm-modal-content><div class="wcm-mobile-title"><div class="wcm-subtitle">${U.MOBILE_ICON}<wcm-text variant="small-regular" color="accent">Mobile</wcm-text></div><div class="wcm-subtitle">${U.SCAN_ICON}<wcm-text variant="small-regular" color="secondary">Scan with your wallet</wcm-text></div></div><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>${c ? f`<wcm-modal-footer><div class="wcm-desktop-title">${U.DESKTOP_ICON}<wcm-text variant="small-regular" color="accent">Desktop</wcm-text></div><div class="wcm-grid">${a} ${l ? f`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null}</div></wcm-modal-footer>` : null}`;
  }
};
vn.styles = [N.globalCss, ol];
vn = ll([
  L("wcm-desktop-wallet-selection")
], vn);
const al = B`div{background-color:var(--wcm-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--wcm-color-bg-3);text-align:center}a{color:var(--wcm-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}`;
var cl = Object.defineProperty, dl = Object.getOwnPropertyDescriptor, ul = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? dl(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
...
let bn = class extends S {
  // -- render ------------------------------------------------------- //
  render() {
    const { termsOfServiceUrl: t, privacyPolicyUrl: e } = fe.state;
...
bn.styles = [N.globalCss, al];
bn = ul([
  L("wcm-legal-notice")
], bn);
const hl = B`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
var fl = Object.defineProperty, ml = Object.getOwnPropertyDescriptor, pl = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? ml(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && fl(e, n, r), r;
};
let yn = class extends S {
  ...
  render() {
    ...
    let s = [ie.recentWalletTemplate(), ...o, ...r];
    s = s.filter(Boolean);
    const l = s.length > 8 || n;
    let a = [];
    l ? a = s.slice(0, 7) : a = s;
    const c = !!a.length;
    return f`<wcm-modal-header title="Connect your wallet" .onAction="${this.onQrcode}" .actionIcon="${U.QRCODE_ICON}"></wcm-modal-header>${c ? f`<wcm-modal-content><div>${a} ${l ? f`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null}</div></wcm-modal-content>` : null}`;
  }
};
yn.styles = [N.globalCss, hl];
yn = pl([
  L("wcm-mobile-wallet-selection")
], yn);
const gl = B`:host{all:initial}.wcm-overlay{top:0;bottom:0;left:0;right:0;position:fixed;z-index:var(--wcm-z-index);overflow:hidden;display:flex;justify-content:center;align-items:center;opacity:0;pointer-events:none;background-color:var(--wcm-overlay-background-color);backdrop-filter:var(--wcm-overlay-backdrop-filter)}@media(max-height:720px) and (orientation:landscape){.wcm-overlay{overflow:scroll;align-items:flex-start;padding:20px 0}}.wcm-active{pointer-events:auto}.wcm-container{position:relative;max-width:360px;width:100%;outline:0;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) var(--wcm-container-border-radius) var(--wcm-container-border-radius);border:1px solid var(--wcm-color-overlay);overflow:hidden}.wcm-card{width:100%;position:relative;border-radius:var(--wcm-container-border-radius);overflow:hidden;box-shadow:0 6px 14px -6px rgba(10,16,31,.12),0 10px 32px -4px rgba(10,16,31,.1),0 0 0 1px var(--wcm-color-overlay);background-color:var(--wcm-color-bg-1);color:var(--wcm-color-fg-1)}@media(max-width:600px){.wcm-container{max-width:440px;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) 0 0}.wcm-card{border-radius:var(--wcm-container-border-radius) var(--wcm-container-border-radius) 0 0}.wcm-overlay{align-items:flex-end}}@media(max-width:440px){.wcm-container{border:0}}`;
var wl = Object.defineProperty, vl = Object.getOwnPropertyDescriptor, Dn = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? vl(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && wl(e, n, r), r;
};
let Ke = class extends S {
  // -- lifecycle ---------------------------------------------------- //
  constructor() {
    super(), this.open = !1, this.active = !1, this.unsubscribeModal = void 0, this.abortController = void 0, this.unsubscribeModal = nt.subscribe((t) => {
  ...
  toggleBodyScroll(t) {
    if (document.querySelector("body"))
      if (t) {
        const n = document.getElementById("wcm-styles");
        n == null || n.remove();
      } else
  ...
  onCloseModal(t) {
    t.target === t.currentTarget && nt.close();
  }
  onOpenModalEvent() {
    this.toggleBodyScroll(!1), this.addKeyboardEvents(), this.open = !0, setTimeout(async () => {
      const t = T.isMobileAnimation() ? { y: ["50vh", "0vh"] } : { scale: [0.98, 1] }, e = 0.1, n = 0.2;
      await Promise.all([
        he(this.overlayEl, { opacity: [0, 1] }, { delay: e, duration: n }).finished,
        he(this.containerEl, t, { delay: e, duration: n }).finished
      ]), this.active = !0;
    }, 0);
  }
  ...
  addKeyboardEvents() {
    this.abortController = new AbortController(), window.addEventListener(
      ...
      (t) => {
        var e;
        t.key === "Escape" ? nt.close() : t.key === "Tab" && ((e = t.target) != null && e.tagName.includes("wcm-") || this.containerEl.focus());
      },
...
const bl = B`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
var yl = Object.defineProperty, xl = Object.getOwnPropertyDescriptor, Qe = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? xl(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
...
const $l = B`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
var Cl = Object.defineProperty, _l = Object.getOwnPropertyDescriptor, El = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? _l(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Cl(e, n, r), r;
};
let xn = class extends S {
  ...
  // -- render ------------------------------------------------------- //
  render() {
    const { recomendedWallets: t } = z.state, e = Ae.manualWallets(), n = [...t, ...e].reverse().slice(0, 4);
    return f`<button @click="${this.onClick}"><div class="wcm-icons">${n.map((o) => {
      const r = T.getWalletIcon(o);
      if (r)
        return f`<img crossorigin="anonymous" src="${r}">`;
      const i = T.getWalletIcon({ id: o.id });
      return i ? f`<img crossorigin="anonymous" src="${i}">` : U.WALLET_PLACEHOLDER;
    })} ${[...Array(4 - n.length)].map(() => U.WALLET_PLACEHOLDER)}</div><wcm-text variant="xsmall-regular">View All</wcm-text></button>`;
  }
};
xn.styles = [N.globalCss, $l];
xn = El([
  L("wcm-view-all-wallets-button")
], xn);
const Al = B`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
var Pl = Object.defineProperty, Ol = Object.getOwnPropertyDescriptor, gt = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Ol(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
...
var Il = Object.defineProperty, Tl = Object.getOwnPropertyDescriptor, Rl = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Tl(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Il(e, n, r), r;
};
let $n = class extends S {
  // -- private ------------------------------------------------------ //
  viewTemplate() {
    return O.isAndroid() && !O.isTelegram() ? f`<wcm-android-wallet-selection></wcm-android-wallet-selection>` : O.isMobile() ? f`<wcm-mobile-wallet-selection></wcm-mobile-wallet-selection>` : f`<wcm-desktop-wallet-selection></wcm-desktop-wallet-selection>`;
  }
  // -- render ------------------------------------------------------- //
  render() {
...
$n.styles = [N.globalCss];
$n = Rl([
  L("wcm-connect-wallet-view")
], $n);
const Ml = B`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var Sl = Object.defineProperty, Dl = Object.getOwnPropertyDescriptor, io = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Dl(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Sl(e, n, r), r;
};
let ut = class extends S {
  ...
  onFormatAndRedirect(t) {
    const { desktop: e, name: n } = O.getWalletRouterData(), o = e == null ? void 0 : e.native, r = e == null ? void 0 : e.universal;
    if (o) {
      const i = O.formatNativeUrl(o, t, n);
      O.openHref(i, "_self");
    } else if (r) {
      const i = O.formatUniversalUrl(r, t, n);
      O.openHref(i, "_blank");
    }
  }
  openDesktopApp() {
  ...
  // -- render ------------------------------------------------------- //
  render() {
    const { name: t, id: e, image_id: n } = O.getWalletRouterData(), { isMobile: o, isWeb: r } = T.getCachedRouterWalletPlatforms();
    return f`<wcm-modal-header title="${t}" .onAction="${T.handleUriCopy}" .actionIcon="${U.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${e}" imageId="${F(n)}" label="${`Continue in ${t}...`}" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Connection can continue loading if ${t} is not installed on your device`}</wcm-text><wcm-platform-selection .isMobile="${o}" .isWeb="${r}" .isRetry="${!0}"><wcm-button .onClick="${this.openDesktopApp.bind(this)}" .iconRight="${U.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection></wcm-info-footer>`;
  }
};
ut.styles = [N.globalCss, Ml];
io([
  q()
...
const Nl = B`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
var Ll = Object.defineProperty, Bl = Object.getOwnPropertyDescriptor, Wl = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Bl(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Ll(e, n, r), r;
};
let Cn = class extends S {
  ...
  // -- render ------------------------------------------------------- //
  render() {
    const { name: t, id: e, image_id: n, homepage: o } = O.getWalletRouterData();
    return f`<wcm-modal-header title="${t}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${e}" imageId="${F(n)}" label="Not Detected" .isStale="${!0}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Download ${t} to continue. If multiple browser extensions are installed, disable non ${t} ones and try again`}</wcm-text><wcm-button .onClick="${() => this.onInstall(o)}" .iconLeft="${U.ARROW_DOWN_ICON}">Download</wcm-button></wcm-info-footer>`;
  }
};
Cn.styles = [N.globalCss, Nl];
Cn = Wl([
  L("wcm-install-wallet-view")
], Cn);
const Ul = B`wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:96px;height:96px;margin-bottom:20px}wcm-info-footer{display:flex;width:100%}.wcm-app-store{justify-content:space-between}.wcm-app-store wcm-wallet-image{margin-right:10px;margin-bottom:0;width:28px;height:28px;border-radius:var(--wcm-wallet-icon-small-border-radius)}.wcm-app-store div{display:flex;align-items:center}.wcm-app-store wcm-button{margin-right:-10px}.wcm-note{flex-direction:column;align-items:center;padding:5px 0}.wcm-note wcm-text{text-align:center}wcm-platform-selection{margin-top:-15px}.wcm-note wcm-text{margin-top:15px}.wcm-note wcm-text span{color:var(--wcm-accent-color)}`;
var jl = Object.defineProperty, kl = Object.getOwnPropertyDescriptor, so = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? kl(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && jl(e, n, r), r;
};
let ht = class extends S {
  ...
  onFormatAndRedirect(t, e = !1) {
    const { mobile: n, name: o } = O.getWalletRouterData(), r = n == null ? void 0 : n.native, i = n == null ? void 0 : n.universal, s = O.isTelegram() ? "_blank" : "_self";
    if (t = O.isTelegram() && O.isAndroid() ? encodeURIComponent(t) : t, r && !e) {
      const l = O.formatNativeUrl(r, t, o);
      O.openHref(l, s);
    } else if (i) {
  ...
  openMobileApp(t = !1) {
    const { walletConnectUri: e } = K.state, n = O.getWalletRouterData();
    e && this.onFormatAndRedirect(e, t), T.setRecentWallet(n);
  }
  onGoToAppStore(t) {
    t && O.openHref(t, "_blank");
  }
  // -- render ------------------------------------------------------- //
  render() {
    const { name: t, id: e, image_id: n, app: o, mobile: r } = O.getWalletRouterData(), { isWeb: i } = T.getCachedRouterWalletPlatforms(), s = o == null ? void 0 : o.ios, l = r == null ? void 0 : r.universal;
    return f`<wcm-modal-header title="${t}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${e}" imageId="${F(n)}" label="Tap 'Open' to continue…" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer class="wcm-note"><wcm-platform-selection .isWeb="${i}" .isRetry="${!0}"><wcm-button .onClick="${() => this.openMobileApp(!1)}" .iconRight="${U.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection>${l ? f`<wcm-text color="secondary" variant="small-thin">Still doesn't work? <span tabindex="0" @click="${() => this.openMobileApp(!0)}">Try this alternate link</span></wcm-text>` : null}</wcm-info-footer><wcm-info-footer class="wcm-app-store"><div><wcm-wallet-image walletId="${e}" imageId="${F(n)}"></wcm-wallet-image><wcm-text>${`Get ${t}`}</wcm-text></div><wcm-button .iconRight="${U.ARROW_RIGHT_ICON}" .onClick="${() => this.onGoToAppStore(s)}" variant="ghost">App Store</wcm-button></wcm-info-footer>`;
  }
};
ht.styles = [N.globalCss, Ul];
so([
  q()
...
var Fl = Object.defineProperty, zl = Object.getOwnPropertyDescriptor, ql = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? zl(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Fl(e, n, r), r;
};
let _n = class extends S {
  // -- render ------------------------------------------------------- //
  render() {
    const { name: t, id: e, image_id: n } = O.getWalletRouterData(), { isDesktop: o, isWeb: r } = T.getCachedRouterWalletPlatforms();
    return f`<wcm-modal-header title="${t}" .onAction="${T.handleUriCopy}" .actionIcon="${U.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr walletId="${e}" imageId="${F(n)}"></wcm-walletconnect-qr></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Scan this QR Code with your phone's camera or inside ${t} app`}</wcm-text><wcm-platform-selection .isDesktop="${o}" .isWeb="${r}"></wcm-platform-selection></wcm-info-footer>`;
  }
};
_n.styles = [N.globalCss, Hl];
_n = ql([
  L("wcm-mobile-qr-connecting-view")
], _n);
var Vl = Object.defineProperty, Zl = Object.getOwnPropertyDescriptor, Kl = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Zl(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Vl(e, n, r), r;
};
let En = class extends S {
  // -- render ------------------------------------------------------- //
  render() {
    return f`<wcm-modal-header title="Scan the code" .onAction="${T.handleUriCopy}" .actionIcon="${U.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>`;
  }
};
En.styles = [N.globalCss];
En = Kl([
  L("wcm-qrcode-view")
], En);
const Yl = B`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
var Gl = Object.defineProperty, Ql = Object.getOwnPropertyDescriptor, Je = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Ql(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Gl(e, n, r), r;
};
const nn = 40;
let ve = class extends S {
  constructor() {
  ...
  isLastPage() {
    const { wallets: t, search: e } = z.state, { listings: n, total: o } = this.search ? e : t;
    return o <= nn || n.length >= o;
  }
  async fetchWallets() {
    var t;
    const { wallets: e, search: n } = z.state, { listings: o, total: r, page: i } = this.search ? n : e;
    if (!this.endReached && (this.firstFetch || r > nn && o.length < r))
      try {
        this.loading = !0;
        ...
        console.error(s), re.openToast(T.getErrorMessage(s), "error");
      } finally {
  ...
  // -- render ------------------------------------------------------- //
  render() {
    const { wallets: t, search: e } = z.state, { listings: n } = this.search ? e : t, o = this.loading && !n.length, r = this.search.length >= 3;
    ...
    const l = !this.loading && !n.length && !s.length, a = {
      "wcm-loading": o,
      "wcm-end-reached": this.endReached || !this.loading,
      "wcm-empty": l
    };
    return f`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(this)}"></wcm-search-input></wcm-modal-header><wcm-modal-content class="${X(a)}"><div class="wcm-grid">${o ? null : i} ${o ? null : s} ${o ? null : n.map(
      (c) => f`${c ? f`<wcm-wallet-button imageId="${c.image_id}" name="${c.name}" walletId="${c.id}" .onClick="${() => this.onConnect(c)}"></wcm-wallet-button>` : null}`
    )}</div><div class="wcm-placeholder-block">${l ? f`<wcm-text variant="big-bold" color="secondary">No results found</wcm-text>` : null} ${!l && this.loading ? f`<wcm-spinner></wcm-spinner>` : null}</div></wcm-modal-content>`;
  }
};
ve.styles = [N.globalCss, Yl];
Je([
  q()
...
const Jl = B`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var Xl = Object.defineProperty, ea = Object.getOwnPropertyDescriptor, lo = (t, e, n, o) => {
  for (var r = o > 1 ? void 0 : o ? ea(e, n) : e, i = t.length - 1, s; i >= 0; i--)
    (s = t[i]) && (r = (o ? s(e, n, r) : s(r)) || r);
  return o && r && Xl(e, n, r), r;
};
let ft = class extends S {
  ...
  // -- private ------------------------------------------------------ //
  onFormatAndRedirect(t) {
    const { desktop: e, name: n } = O.getWalletRouterData(), o = e == null ? void 0 : e.universal;
    if (o) {
      const r = O.formatUniversalUrl(o, t, n);
      O.openHref(r, "_blank");
    }
  }
  openWebWallet() {
  ...
  // -- render ------------------------------------------------------- //
  render() {
    const { name: t, id: e, image_id: n } = O.getWalletRouterData(), { isMobile: o, isDesktop: r } = T.getCachedRouterWalletPlatforms(), i = O.isMobile();
    return f`<wcm-modal-header title="${t}" .onAction="${T.handleUriCopy}" .actionIcon="${U.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${e}" imageId="${F(n)}" label="${`Continue in ${t}...`}" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`${t} web app has opened in a new tab. Go there, accept the connection, and come back`}</wcm-text><wcm-platform-selection .isMobile="${o}" .isDesktop="${i ? !1 : r}" .isRetry="${!0}"><wcm-button .onClick="${this.openWebWallet.bind(this)}" .iconRight="${U.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection></wcm-info-footer>`;
  }
};
ft.styles = [N.globalCss, Jl];
lo([
  q()
], ft.prototype, "isError", 2);
ft = lo([
...
//# sourceMappingURL=index-Di1cPyy0.js.map
