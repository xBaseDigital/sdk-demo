import { q as Qe, r as Ze, t as Xe, E as et } from "./index-DK26g4Jf.js";
import { r as tt } from "./sha3-CijZRJ4X.js";
import { D as Z, g as w, h as ce, y as nt } from "./hooks.module-B57kiOHD.js";
class A {
  constructor(e, n) {
...
}, _e = "Unspecified error message.", st = "Unspecified server error.";
function se(t, e = _e) {
...
function rt(t, { shouldIncludeStack: e = !1 } = {}) {
  ...
  if (t && typeof t == "object" && !Array.isArray(t) && ee(t, "code") && it(t.code)) {
    const s = t;
    n.code = s.code, s.message && typeof s.message == "string" ? (n.message = s.message, ee(s, "data") && (n.data = s.data)) : (n.message = se(n.code), n.data = { originalError: de(t) });
  } else
    n.code = y.rpc.internal, n.message = le(t, "message") ? t.message : _e, n.data = { originalError: de(t) };
...
async function Ue(t, e) {
  const n = je(t), s = await crypto.subtle.exportKey(n, e);
  return re(new Uint8Array(s));
}
async function We(t, e) {
  const n = je(t), s = z(e).buffer;
...
class wt {
  constructor() {
    this.storage = new A("CBWSDK", "SCWKeyManager"), this.ownPrivateKey = null, this.ownPublicKey = null, this.peerPublicKey = null, this.sharedSecret = null;
  }
...
const K = "4.2.3", qe = "@coinbase/wallet-sdk";
...
const ue = "accounts", he = "activeChain", fe = "availableChains", pe = "walletCapabilities";
class vt {
  constructor(e) {
    var n, s, r;
    this.metadata = e.metadata, this.communicator = e.communicator, this.callback = e.callback, this.keyManager = new wt(), this.storage = new A("CBWSDK", "SCWStateManager"), this.accounts = (n = this.storage.loadObject(ue)) !== null && n !== void 0 ? n : [], this.chain = this.storage.loadObject(he) || {
  ...
  async handshake(e) {
    ...
    if ("error" in l)
      throw l.error;
    const h = l.value;
    this.accounts = h, this.storage.storeObject(ue, h), (s = this.callback) === null || s === void 0 || s.call(this, "accountsChanged", h);
  }
  async request(e) {
    var n;
    ...
    switch (e.method) {
      ...
      case "wallet_getCapabilities":
        return this.storage.loadObject(pe);
  ...
  async decryptResponseMessage(e) {
    ...
    if (c) {
      const h = Object.entries(c).map(([f, g]) => ({
        id: Number(f),
        rpcUrl: g
      }));
      this.storage.storeObject(fe, h), this.updateChain(this.chain.id, h);
    }
    const l = (s = a.data) === null || s === void 0 ? void 0 : s.capabilities;
    return l && this.storage.storeObject(pe, l), a;
  }
  updateChain(e, n) {
    var s;
    const r = n ?? this.storage.loadObject(fe), i = r == null ? void 0 : r.find((a) => a.id === e);
    return i ? (i !== this.chain && (this.chain = i, this.storage.storeObject(he, i), (s = this.callback) === null || s === void 0 || s.call(this, "chainChanged", L(i.id))), !0) : !1;
  }
}
var J, ge;
function Be() {
  ...
  function s(o, u) {
    let b = o.toString(16);
    b.length % 2 !== 0 && (b = "0" + b);
    const p = b.match(/.{1,2}/g).map((k) => parseInt(k, 16));
    for (; p.length < u; )
      p.unshift(0);
  ...
  function r(o, u) {
    ...
    if (b) {
      ...
      p = o;
    return p &= (1n << BigInt(u)) - 1n, p;
  }
  function i(o, u, b) {
    const p = e(u);
    return o = c(o), b ? o.length < u ? (o.copy(p), p) : o.slice(0, u) : o.length < u ? (o.copy(p, u - o.length), p) : o.slice(-u);
  }
  function a(o, u) {
    return i(o, u, !0);
  }
  function c(o) {
    if (!Buffer.isBuffer(o))
      if (Array.isArray(o))
        ...
        g(o) ? o = Buffer.from(f(d(o)), "hex") : o = Buffer.from(o);
...
function St() {
  ...
  function a(d, o) {
    ...
    if (l(d)) {
      ...
      p = [], d = d.slice(0, d.lastIndexOf("[")), typeof o == "string" && (o = JSON.parse(o));
      for (k in o)
        p.push(a(d, o[k]));
      if (u === "dynamic") {
      ...
      if (d === "bytes")
        return o = new Buffer(o), p = Buffer.concat([a("uint256", o.length), o]), o.length % 32 !== 0 && (p = Buffer.concat([p, t.zeros(32 - o.length % 32)])), p;
  ...
  function h(d, o) {
    var u = [], b = [], p = 32 * d.length;
    for (var k in d) {
      var I = e(d[k]), v = o[k], C = a(I, v);
      c(I) ? (u.push(a("uint256", p)), b.push(C), p += C.length) : u.push(C);
    }
  ...
  function f(d, o) {
    ...
    for (var u, b, p = [], k = 0; k < d.length; k++) {
      var I = e(d[k]), v = o[k];
      if (I === "bytes")
        p.push(v);
      else if (I === "string")
        p.push(new Buffer(v, "utf8"));
      else if (I === "bool")
        p.push(new Buffer(v ? "01" : "00", "hex"));
      else if (I === "address")
        p.push(t.setLength(v, 20));
      else if (I.startsWith("bytes")) {
        if (u = n(I), u < 1 || u > 32)
          throw new Error("Invalid bytes<N> width: " + u);
        p.push(t.setLengthRight(v, u));
        ...
        p.push(t.bufferBEFromBigInt(b, u / 8));
        ...
        p.push(t.bufferBEFromBigInt(Ve, u / 8));
      } else
  ...
  const t = /* @__PURE__ */ Be(), e = /* @__PURE__ */ St(), n = {
      ...
      if (l) {
        const g = (d, o, u) => {
          ...
          if (o.lastIndexOf("]") === o.length - 1) {
            const b = o.slice(0, o.lastIndexOf("[")), p = u.map((k) => g(d, b, k));
        ...
        for (const g of c[i]) {
          ...
          if (d !== void 0)
            if (g.type === "bytes")
              ...
              h.push("bytes32"), d = t.keccak(this.encodeData(g.type, d, c, l)), f.push(d);
            else {
              if (g.type.lastIndexOf("]") === g.type.length - 1)
                throw new Error("Arrays currently unimplemented in encodeData");
              h.push(g.type), f.push(d);
            }
        }
    ...
    encodeType(i, a) {
      ...
      for (const h of l) {
        ...
        c += h + "(" + a[h].map(({ name: g, type: d }) => d + " " + g).join(",") + ")";
      }
      return c;
    },
    /**
...
var Mt = /* @__PURE__ */ Ct();
const B = /* @__PURE__ */ Qe(Mt), At = "walletUsername", ne = "Addresses", _t = "AppVersion";
function E(t) {
...
class xt {
  ...
  async encrypt(e) {
    ...
    const s = crypto.getRandomValues(new Uint8Array(12)), r = await crypto.subtle.importKey("raw", z(n), { name: "aes-gcm" }, !1, ["encrypt", "decrypt"]), i = new TextEncoder(), a = await window.crypto.subtle.encrypt({
      name: "AES-GCM",
      iv: s
    }, r, i.encode(e)), c = 16, l = a.slice(a.byteLength - c), h = a.slice(0, a.byteLength - c), f = new Uint8Array(l), g = new Uint8Array(h), d = new Uint8Array([...s, ...f, ...g]);
    return re(d);
  }
  /**
   *
  ...
  async decrypt(e) {
    ...
    return new Promise((s, r) => {
      (async function() {
        const i = await crypto.subtle.importKey("raw", z(n), { name: "aes-gcm" }, !1, ["encrypt", "decrypt"]), a = z(e), c = a.slice(0, 12), l = a.slice(12, 28), h = a.slice(28), f = new Uint8Array([...h, ...l]), g = {
          name: "AES-GCM",
          iv: new Uint8Array(c)
        };
        try {
          const d = await window.crypto.subtle.decrypt(g, i, f), o = new TextDecoder();
          s(o.decode(d));
        } catch (d) {
          r(d);
        }
...
class Tt {
  ...
  constructor({ session: e, linkAPIUrl: n, listener: s }) {
    this.destroyed = !1, this.lastHeartbeatResponse = 0, this.nextReqId = _(1), this._connected = !1, this._linked = !1, this.shouldFetchUnseenEventsOnConnect = !1, this.requestResolutions = /* @__PURE__ */ new Map(), this.handleSessionMetadataUpdated = (i) => {
      if (!i)
        return;
      (/* @__PURE__ */ new Map([
      ...
      switch (i) {
        ...
        case R.CONNECTED:
          a = await this.handleConnected(), this.updateLastHeartbeat(), setInterval(() => {
            this.heartbeat();
          }, we), this.shouldFetchUnseenEventsOnConnect && this.fetchUnseenEventsAPI();
          break;
        case R.CONNECTING:
          break;
      }
...
class Nt {
  ...
  makeRequestId() {
    ...
    const e = this._nextRequestId, n = Oe(e.toString(16));
    return this.callbacks.get(n) && this.callbacks.delete(n), e;
  }
}
const ye = "session:id", ke = "session:secret", Ee = "session:linked";
class D {
  ...
  static load(e) {
    const n = e.getItem(ye), s = e.getItem(Ee), r = e.getItem(ke);
  ...
  save() {
    return this.storage.setItem(ye, this.id), this.storage.setItem(ke, this.secret), this.persistLinked(), this;
  }
  persistLinked() {
...
}, $t = "https://keys.coinbase.com/connect", Ie = "https://www.walletlink.org", Jt = "https://go.cb-w.com/walletlink";
class ve {
  constructor() {
...
class x {
  ...
  subscribe() {
    const e = D.load(this.storage) || D.create(this.storage), { linkAPIUrl: n } = this, s = new Tt({
      ...
      linkAPIUrl: n,
      listener: this
    }), r = this.isMobileWeb ? new ve() : new Ft();
    return s.connect(), { session: e, ui: r, connection: s };
  }
  resetAndReload() {
    this.connection.destroy().then(() => {
      const e = D.load(this.storage);
      (e == null ? void 0 : e.id) === this._session.id && A.clearAll(), document.location.reload();
    }).catch((e) => {
    });
  }
  ...
  signAndSubmitEthereumTransaction(e) {
    return this.sendRequest({
      ...
      params: {
        ...
        maxPriorityFeePerGas: e.maxPriorityFeePerGas ? M(e.maxPriorityFeePerGas) : null,
        gasLimit: e.gasLimit ? M(e.gasLimit) : null,
        chainId: e.chainId,
        shouldSubmit: !0
      }
  ...
  watchAsset(e, n, s, r, i, a) {
    ...
    let l = null;
    const h = T(8), f = (g) => {
      this.publishWeb3RequestCanceledEvent(h), this.handleErrorResponse(h, c.method, g), l == null || l();
    };
...
const Se = "DefaultChainId", Ce = "DefaultJsonRpcUrl";
class Ye {
  constructor(e) {
    this._relay = null, this._addresses = [], this.metadata = e.metadata, this._storage = new A("walletlink", Ie), this.callback = e.callback || null;
  ...
  get jsonRpcUrl() {
    var e;
    return (e = this._storage.getItem(Ce)) !== null && e !== void 0 ? e : void 0;
  }
  set jsonRpcUrl(e) {
  ...
  updateProviderInfo(e, n) {
    ...
    this._storage.setItem(Se, n.toString(10)), U(n) !== r && ((s = this.callback) === null || s === void 0 || s.call(this, "chainChanged", L(n)));
  }
  async watchAsset(e) {
  ...
  async addEthereumChain(e) {
    ...
    if (i === this.getChainId())
      return !1;
    const a = this.initializeRelay(), { rpcUrls: c = [], blockExplorerUrls: l = [], chainName: h, iconUrls: f = [], nativeCurrency: g } = r, d = await a.addEthereumChain(i.toString(), c, f, l, h, g);
    if (E(d))
      return !1;
  ...
  getChainId() {
    var e;
    return Number.parseInt((e = this._storage.getItem(Se)) !== null && e !== void 0 ? e : "1", 10);
  }
...
const $e = "SignerType", Je = new A("CBWSDK", "SignerConfigurator");
function Vt() {
  return Je.getItem($e);
}
function Qt(t) {
...
Please see https://www.smartwallet.dev/guides/tips/popup-tips#cross-origin-opener-policy for more information.`, nn = () => {
  let t;
  return {
...
}, { checkCrossOriginOpenerPolicy: sn, getCrossOriginOpenerPolicy: rn } = nn(), Me = 420, Ae = 540;
function an(t) {
  const e = (window.innerWidth - Me) / 2 + window.screenX, n = (window.innerHeight - Ae) / 2 + window.screenY;
  cn(t);
  const s = window.open(t, "Smart Wallet", `width=${Me}, height=${Ae}, left=${e}, top=${n}`);
  if (s == null || s.focus(), !s)
...
class dn {
  constructor({ url: e = $t, metadata: n, preference: s }) {
    this.popup = null, this.listeners = /* @__PURE__ */ new Map(), this.postMessage = async (r) => {
      ...
      on(this.popup), this.popup = null, this.listeners.forEach(({ reject: r }, i) => {
        r(m.provider.userRejectedRequest("Request rejected")), window.removeEventListener("message", i);
      }), this.listeners.clear();
    }, this.waitForPopupLoaded = async () => this.popup && !this.popup.closed ? (this.popup.focus(), this.popup) : (this.popup = an(this.url), this.onMessage(({ event: r }) => r === "PopupUnload").then(this.disconnect).catch(() => {
...
class pn extends hn {
  constructor(e) {
    var { metadata: n } = e, s = e.preference, { keysUrl: r } = s, i = fn(s, ["keysUrl"]);
    super(), this.signer = null, this.isCoinbaseWallet = !0, this.metadata = n, this.preference = i, this.communicator = new dn({
      url: r,
      metadata: n,
      preference: i
    });
  ...
  async request(e) {
    try {
      ...
      const { code: s } = n;
      return s === y.provider.unauthorized && this.disconnect(), Promise.reject(ln(n));
    }
  }
  ...
  async disconnect() {
    var e;
    await ((e = this.signer) === null || e === void 0 ? void 0 : e.cleanup()), this.signer = null, A.clearAll(), this.emit("disconnect", m.provider.disconnected("User initiated disconnection"));
  }
...
function mn(t) {
  ...
  return (e = Et(n)) !== null && e !== void 0 ? e : new pn(n);
}
const bn = {
  options: "all"
};
function En(t) {
  ...
  const s = {
    ...
    preference: Object.assign(bn, (e = t.preference) !== null && e !== void 0 ? e : {})
  };
  gn(s.preference);
  let r = null;
  return {
    getProvider: () => (r || (r = mn(s)), r)
  };
}
export {
  En as createCoinbaseWalletSDK
};
